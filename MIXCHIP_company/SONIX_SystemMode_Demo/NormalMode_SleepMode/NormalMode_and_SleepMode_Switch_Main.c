...
File name:	 NormalMode_and_SleepMode_Switch_Main.c 
Author:		 Lian_Jin
Date：	     2011/9/07
Email:		 lian_jin@sonix.com.cn

Description: NormalMode --> SleepMode
...
----------------------------------------
EPROM Check Sum   : 13513 [0x34C9] 
Security Check Sum: 6795 [0x1A8B] 
----------------------------------------
Rom total size : 4092 [0xFFC] words
Rom has  used  : 90 [0x5A] words			[composed by: all segments size]
Rom Remains    : 4002 [0xFA2] words
---------------------------------------
...
/*------------------------------------------------------------------------------------------------------	
		...
		或者使用宏命令的方式：“SLEEPMODE”
------------------------------------------------------------------------------------------------------*/						
		FCPUM0 = 1;		 				//唤醒源：P0、P1、ResetCircuit
	}
}
